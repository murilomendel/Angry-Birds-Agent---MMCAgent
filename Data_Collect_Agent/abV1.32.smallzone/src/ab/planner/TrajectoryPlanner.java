...
public class TrajectoryPlanner {
    ...
    public ArrayList<Point> estimateLaunchPoint(Rectangle slingshot, Point targetPoint) {
        ...
        if (bestError < 1000)
        {
            ...
            pts.add(findReleasePoint(slingshot, theta1)); // Add the release point 2
        }
        bestError = 1000;
        ...
        theta2 = actualToLaunch(theta2); // In Radians Math.toDegres(), Math.toRadians()
        ...
        if (theta2 < Math.toRadians(75) && theta2 != theta1 && bestError < 1000)
            pts.add(findReleasePoint(slingshot, theta2)); // Add release point 2
