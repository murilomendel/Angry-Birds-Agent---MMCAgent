/*****************************************************************************xxx
 ** ANGRYBIRDS AI AGENT TARGET SELECTION FRAMEWORK
...
public class MLP {
	...
	public int[] getTarget() throws IOException {
		...
		System.out.println("");
		//Shot command path
		//String pyTargetCommand = "python ./src/ab/mlp/targetMLP1.py";
		String pyTargetCommand = "python ./targetMLP.py";
	...
	public void createLog(String logInfo) {
		...
		String logPath = String.format(System.getProperty("user.dir") + "/dataSet/trainSet/mlpShot.txt");
